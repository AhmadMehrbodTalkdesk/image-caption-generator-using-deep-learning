# https://github.com/nithintata/image-caption-generator-using-deep-learning
import numpy as np
...
imagefile = '~/projects/ImageTagging/2b765fd505de0282edaadfb0c54ebc2e.jpeg' 
modelfile = 'new-model-1.h5'

ap = argparse.ArgumentParser()
ap.add_argument("-i", "--image", help="path to input image")
ap.add_argument("-m", "--model", help="path to model file")
...
classify(os.path.expanduser(imagefile))
